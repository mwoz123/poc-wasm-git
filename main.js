...
// lg2_async.js
var require_lg2_async = __commonJS({
  "lg2_async.js"(exports, module2) {
    ...
    if (!Module.print && !Module.printErr) {
      ...
      Module.callWithOutput = (args) => {
        ...
        const err2 = capturedError.join("\n");
        capturedOutput = null;
        capturedError = null;
        if (!quitStatus) {
          return ret;
        } else {
          throw quitStatus + ": " + err2;
        }
      };
    }
    ...
    var tempDouble;
    var tempI64;
    var ASM_CONSTS = { 105580: ($0, $1, $2) => Module.emscriptenhttpwrite($0, $1, $2) };
    function emscriptenhttp_do_get(url, buf_size) {
      return Asyncify.handleAsync(async () => {
        const urlString = UTF8ToString(url);
        return await Module.emscriptenhttpconnect(urlString, buf_size);
      });
    }
    function emscriptenhttp_do_post(url, buf_size) {
      return Asyncify.handleAsync(async () => {
        const urlString = UTF8ToString(url);
        return await Module.emscriptenhttpconnect(urlString, buf_size, "POST", { "Content-Type": urlString.indexOf("git-upload-pack") > 0 ? "application/x-git-upload-pack-request" : "application/x-git-receive-pack-request" });
      });
    }
    function emscriptenhttp_do_read(connectionNo, buffer, buf_size) {
      return Asyncify.handleAsync(async () => await Module.emscriptenhttpread(connectionNo, buffer, buf_size));
    }
    ...
    var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, ErrnoError: null, genericErrors: {}, filesystems: null, syncFSRequests: 0, lookupPath(path, opts = {}) {
      ...
      FS.filesystems = { "MEMFS": MEMFS, "IDBFS": IDBFS, "NODEFS": NODEFS };
    ...
    var Asyncify = { instrumentWasmImports(imports) {
      var importPattern = /^(emscriptenhttp_do_get|emscriptenhttp_do_read|emscriptenhttp_do_post|invoke_.*|__asyncjs__.*)$/;
    ...
    }, instrumentWasmExports(exports2) {
      var ret = {};
      for (let [x, original] of Object.entries(exports2)) {
        if (typeof original == "function") {
          ret[x] = function() {
    ...
    var wasmImports = { Z: ___syscall_chmod, B: ___syscall_connect, l: ___syscall_faccessat, b: ___syscall_fcntl64, W: ___syscall_fstat64, R: ___syscall_getcwd, L: ___syscall_getdents64, A: ___syscall_getsockopt, T: ___syscall_lstat64, O: ___syscall_mkdirat, U: ___syscall_newfstatat, N: ___syscall_openat, M: ___syscall_poll, J: ___syscall_readlinkat, z: ___syscall_recvfrom, I: ___syscall_renameat, h: ___syscall_rmdir, y: ___syscall_sendto, g: ___syscall_socket, V: ___syscall_stat64, H: ___syscall_symlink, i: ___syscall_unlinkat, E: ___syscall_utimensat, X: __emscripten_get_now_is_monotonic, u: __gmtime_js, v: __localtime_js, w: __mktime_js, r: __mmap_js, t: __munmap_js, F: __tzset_js, c: _abort, m: _emscripten_asm_const_int, k: _emscripten_date_now, G: _emscripten_get_heap_max, f: _emscripten_get_now, Y: _emscripten_memcpy_js, D: _emscripten_resize_heap, s: emscriptenhttp_do_get, n: emscriptenhttp_do_post, o: emscriptenhttp_do_read, P: _environ_get, Q: _environ_sizes_get, a: _exit, d: _fd_close, q: _fd_pread, p: _fd_pwrite, j: _fd_read, x: _fd_seek, S: _fd_sync, e: _fd_write, C: _getaddrinfo, K: _getentropy, _: _strftime };
    ...
    var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["fa"])(a0, a1);
    var _htonl = (a0) => (_htonl = wasmExports["ga"])(a0);
    var _ntohs = (a0) => (_ntohs = wasmExports["ha"])(a0);
    var _htons = (a0) => (_htons = wasmExports["ia"])(a0);
    var _emscripten_builtin_memalign = (a0, a1) => (_emscripten_builtin_memalign = wasmExports["ja"])(a0, a1);
    var setTempRet0 = (a0) => (setTempRet0 = wasmExports["ka"])(a0);
    var stackAlloc = (a0) => (stackAlloc = wasmExports["la"])(a0);
    var _asyncify_start_unwind = (a0) => (_asyncify_start_unwind = wasmExports["ma"])(a0);
    var _asyncify_stop_unwind = () => (_asyncify_stop_unwind = wasmExports["na"])();
    var _asyncify_start_rewind = (a0) => (_asyncify_start_rewind = wasmExports["oa"])(a0);
    var _asyncify_stop_rewind = () => (_asyncify_stop_rewind = wasmExports["pa"])();
    var ___start_em_js = Module["___start_em_js"] = 104872;
    var ___stop_em_js = Module["___stop_em_js"] = 105580;
    ...
    if (Module["noInitialRun"])
      shouldRunNow = false;
    run();
    var emscriptenhttpconnections = {};
    var httpConnectionNo = 0;
    var chmod = FS.chmod;
    ...
    if (ENVIRONMENT_IS_WEB) {
      ...
      Object.assign(Module, { emscriptenhttpconnect: async function(url, buffersize, method, headers) {
        let result = new Promise((resolve, reject) => {
          ...
          emscriptenhttpconnections[httpConnectionNo] = { xhr, resultbufferpointer: 0, buffersize };
          if (method === "GET") {
            xhr.onload = function() {
        ...
        const connection = emscriptenhttpconnections[connectionNo];
        function handleResponse(connection2, buffer2, buffersize2) {
          let bytes_read = connection2.xhr.response.byteLength - connection2.resultbufferpointer;
          if (bytes_read > buffersize2) {
            bytes_read = buffersize2;
          }
          const responseChunk = new Uint8Array(connection2.xhr.response, connection2.resultbufferpointer, bytes_read);
          writeArrayToMemory(responseChunk, buffer2);
          connection2.resultbufferpointer += bytes_read;
          return bytes_read;
        }
      ...
      Object.assign(Module, { emscriptenhttpconnect: function(url, buffersize, method, headers) {
        ...
        const workerData = { statusArray, resultArray, url, method: method ? method : "GET", headers };
        new Worker("(" + function requestWorker() {
          const { workerData: workerData2 } = require("worker_threads");
          const req = (workerData2.url.indexOf("https") === 0 ? require("https") : require("http")).request(workerData2.url, { headers: workerData2.headers, method: workerData2.method }, (res) => {
            res.on("data", (chunk) => {
              const previousStatus = workerData2.statusArray[0];
              if (previousStatus !== 0) {
                Atomics.wait(workerData2.statusArray, 0, previousStatus);
              }
              workerData2.resultArray.set(chunk);
              Atomics.store(workerData2.statusArray, 0, chunk.length);
              Atomics.notify(workerData2.statusArray, 0, 1);
            });
          });
          if (workerData2.method === "POST") {
            while (workerData2.statusArray[0] !== 0) {
              Atomics.wait(workerData2.statusArray, 0, -1);
              const length = workerData2.statusArray[0];
              if (length === 0) {
                break;
              }
              req.write(Buffer.from(workerData2.resultArray.slice(0, length)));
              Atomics.store(workerData2.statusArray, 0, -1);
              Atomics.notify(workerData2.statusArray, 0, 1);
            }
          }
          req.end();
        }.toString() + ")()", { eval: true, workerData });
...
var import_lg2_async = __toESM(require_lg2_async());
...
var MyPlugin = class extends import_obsidian.Plugin {
  async onload() {
    ...
    const lg2 = await (0, import_lg2_async.default)(this.app.vault.adapter, import_obsidian2.requestUrl, "./lg2_async.wasm");
